...
public class configuracaoSeguranca {
   ...
   // private DetalhesUsuarioService detalhesUsuarioServico = new DetalhesUsuarioService();

   // public void ConfiguracaoSeguranca(DetalhesUsuarioService detalhesUsuarioServico) {
